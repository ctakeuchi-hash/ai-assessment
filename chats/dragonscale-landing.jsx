...
const SOLUTIONS = [
  {
    ...
    tagline: "Find your gaps before they cost you.",
    description:
      "Answer 15 targeted questions across readiness, operations, and growth. Get a dynamic AI-generated report with your blind spots, quick wins, and a 90-day roadmap — personalized to your industry.",
  ...
  {
    icon: "🔧",
    tag: "Fixed Scope · Fast ROI",
    name: "DragonScale Build",
    tagline: "We diagnose, design, and deploy — in weeks, not quarters.",
    description:
      "A packaged sprint that takes the highest-value opportunity from your assessment and turns it into a working AI solution. Custom-scoped, hands-on, and built by someone who's seen your problems at Fortune 500 scale.",
  ...
  },
  {
    ...
    name: "DragonScale Brain",
    tagline: "AI that runs your ops while you run your business.",
    description:
      "A fully managed AI layer — automations, workflows, and intelligent assistants — customized to your stack, hosted in the cloud, and actively maintained. No hardware. No headcount. Just leverage.",
    cta: "See How Brain Works",
    href: "#contact",
    accent: "#06b6d4",
    step: "03",
  },
...
const PAIN_POINTS = [
  ...
  "You know you're leaving money on the table but can't see where",
  "You've looked at AI tools and can't tell what's real vs. hype",
...
const STATS = [
  ...
  { value: "3-step", label: "Assess → Build → Run framework" },
  { value: "0", label: "Hours of client IT setup required" },
];
      ...
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", position: "relative", padding: "120px 48px 80px", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 720, position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ fontSize: "clamp(42px, 6vw, 80px)", fontWeight: 800, lineHeight: 1.05, marginBottom: 28, letterSpacing: "-0.02em" }}>
            {["Your", "team", "is", "doing", "work"].map((w, i) => (
            ...
            <span style={{ color: "#c8a96e", fontStyle: "italic" }}>
              {["a", "machine", "should", "handle."].map((w, i) => (
                <span key={i} className="hero-word" style={{ animationDelay: `${(i + 5) * 0.08}s`, marginRight: "0.25em" }}>{w}</span>
              ))}
            </span>
          </h1>

          <p className="dm" style={{ fontSize: 18, color: "#a09880", lineHeight: 1.7, marginBottom: 16, maxWidth: 560 }}>
            We help businesses find the hours, revenue, and clarity buried in their operations — then build the AI that unlocks them.
          </p>

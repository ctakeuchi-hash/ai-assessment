...
const TIERS = [
  {
    name: "Pilot",
    icon: "🎯",
    tagline: "Fix your #1 AI gap in one week.",
    bestFor: "Businesses who've tried Claude for Small Business and hit its limits.",
    duration: "1 week",
    founderPrice: "$1,500",
    standardPrice: "$2,500",
    accent: "#f97316",
    includes: [
      "60-min discovery call to identify your #1 AI gap",
      "1 targeted automation built around that specific gap",
      "Handoff documentation",
      "14-day email support post-launch",
    ],
    roiAnchor: "Most clients see results in the first week — lowest-risk entry point",
    scopeNote: "Single gap · Single workflow · 'Beyond the 15 Skills'",
  },
  {
    name: "Spark",
    icon: "⚡",
    ...
    <div style={{ fontFamily: "'Playfair Display', Georgia, serif", background: "#0a0a0f", color: "#f0ede8", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, padding: "18px 48px", display: "flex", alignItems: "center", justifyContent: "space-between", background: scrolled ? "rgba(10,10,15,0.96)" : "transparent", borderBottom: scrolled ? "1px solid rgba(200,169,110,0.12)" : "none", backdropFilter: scrolled ? "blur(16px)" : "none", transition: "all 0.3s" }}>
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
          <a href="/assessment" className="dm" style={{ fontSize: 13, color: "#a09880", textDecoration: "none" }}>Free Assessment</a>
          <a href="https://calendly.com/ctakeuchi/30min" className="btn-gold" style={{ padding: "10px 22px", fontSize: 13 }}>Book Scoping Call</a>
        </div>
      </nav>
      ...
      <section style={{ minHeight: "85vh", display: "flex", alignItems: "center", padding: "120px 48px 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 760, position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
            <a href="https://calendly.com/ctakeuchi/30min" className="btn-gold">Book Free Scoping Call →</a>
            <a href="/assessment" className="btn-outline">Take the Assessment First</a>
          </div>
        ...
        <div className="hide-sm" style={{ position: "absolute", right: "8%", top: "50%", transform: "translateY(-50%)", textAlign: "center", opacity: 0.6 }}>
          ...
          <div style={{ fontSize: 52, fontWeight: 800, color: "#c8a96e", letterSpacing: "-0.03em", lineHeight: 1 }}>$1,500</div>
      ...
      <section id="pricing" style={{ padding: "100px 48px", background: "rgba(200,169,110,0.02)", borderTop: "1px solid rgba(200,169,110,0.1)" }}>
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          <div ref={reg("price-h")} className={`fade-up ${vis("price-h") ? "in" : ""}`} style={{ marginBottom: 16 }}>
            ...
            <h2 style={{ fontSize: "clamp(28px, 3.5vw, 48px)", fontWeight: 800, letterSpacing: "-0.02em" }}>Four scopes.<br /><span style={{ color: "#c8a96e", fontStyle: "italic" }}>One framework.</span></h2>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24 }}>
            {TIERS.map((t, i) => (
              <div key={i} ref={reg(`tier-${i}`)} className={`card fade-up ${t.featured ? "tier-featured" : ""} ${vis(`tier-${i}`) ? "in" : ""}`} style={{ transitionDelay: `${i * 0.15}s`, padding: "40px 36px", position: "relative", display: "flex", flexDirection: "column" }}>
                ...
                <a href="https://calendly.com/ctakeuchi/30min" className="btn-gold" style={{ background: t.featured ? "#a855f7" : "#c8a96e", textAlign: "center", color: t.featured ? "#fff" : "#0a0a0f" }}>
                  Book Scoping Call →
                </a>
              </div>
            ))}
      ...
      <section style={{ padding: "100px 48px", position: "relative", overflow: "hidden" }}>
        ...
        <div ref={reg("final")} className={`fade-up ${vis("final") ? "in" : ""}`} style={{ maxWidth: 640, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="https://calendly.com/ctakeuchi/30min" className="btn-gold" style={{ fontSize: 16, padding: "16px 40px" }}>Book Scoping Call →</a>
            <a href="/assessment" className="btn-outline" style={{ fontSize: 16, padding: "16px 40px" }}>Take Free Assessment</a>
          </div>
      ...
      <footer style={{ borderTop: "1px solid rgba(200,169,110,0.1)", padding: "32px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
        ...
        <div style={{ display: "flex", gap: 24 }}>
          <a href="/assessment" className="dm" style={{ fontSize: 12, color: "#6b6458", textDecoration: "none" }}>Assess</a>

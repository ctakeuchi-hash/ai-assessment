...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;max-width:600px;width:100%">
  ...
  <tr><td style="background:#1a1208;padding:32px;text-align:center">
    ...
    <a href="https://calendly.com/chris-dragonscale" style="display:inline-block;background:#e8a020;color:#08090f;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,sans-serif;font-size:13px;font-weight:700;padding:13px 26px;text-decoration:none;letter-spacing:.5px">Book Free Strategy Call →</a>
  </td></tr>
